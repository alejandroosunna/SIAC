<%@ Page Language="C#" MasterPageFile="~/Alumno.master" AutoEventWireup="true" CodeFile="ChatUser.aspx.cs" Inherits="ChatUser" %>
<asp:Content ID="Principal" ContentPlaceHolderID="CPHBody" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getUser() {
            $.ajax({
                ...
                url: "ChatUser.aspx/ObtenerUsuario",
                data: {},
                dataType: 'json',
